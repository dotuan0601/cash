        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Chỉnh sửa Dịch Vụ </h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->

                <form class="form-horizontal" method="post" action="{{ route('admin.service.update',['id'=>$service->id]) }}">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input class="form-control col-md-10 " id="feather_image" name="feather_image"
                                       placeholder="featherImage" value="{{$service->feather_image}}"
                                       type="text">
                            ...
                            <div class="col-md-3">
                                <img id="holder" style="margin-top:15px;max-height:100px;" src="{{$service->feather_image}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input class="form-control" id="categoryName" name="name" placeholder="Tên"
                                       type="text" required value="{{$service->name }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input class="form-control" id="categoryName" name="summary" placeholder="Mô tả"
                                       type="text" required value="{{$service->summary }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input class="form-control" id="categoryName" name="icon" placeholder="ICON"
                                       type="text" required value="{{$service->icon }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input class="form-control" id="categoryName" name="price" placeholder="Giá"
                                       type="text" required value="{{$service->price }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input class="form-control" id="categoryName" name="order" placeholder="Thứ tự"
                                       type="number" value="{{$service->order}}" required>
                            </div>
