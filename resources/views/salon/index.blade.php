        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Danh sách Salon</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                        ...
                        @foreach ($salons as $salon)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.salon.edit', ['id' => $salon->id]) }}"
                                    ...
                                    <form class="inline" method="POST"  onsubmit="return confirm('Bạn có chắc chắn muốn xóa nội dung này không?');"
                                          action="{{ route('admin.salon.destroy', ['id' => $salon->id]) }}">
                ...
                <div class="box-footer clearfix no-border">
                    <a href="{{ route('admin.salon.create') }}" class="btn btn-flat btn-primary">Thêm salon mới</a>
                </div>
