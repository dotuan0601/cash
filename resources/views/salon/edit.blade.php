        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Chỉnh sửa Salon </h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->

                <form class="form-horizontal" method="post" action="{{ route('admin.salon.update',['id'=>$salon->id]) }}">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input class="form-control" id="categoryName" name="name" placeholder="Tên"
                                       type="text" required value="{{$salon->name }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input class="form-control" id="categoryName" name="summary" placeholder="Mô tả"
                                       type="text" required value="{{$salon->summary }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input class="form-control" id="categoryName" name="location" placeholder="Địa điểm"
                                       type="text" required value="{{$salon->location }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input class="form-control"  name="max_slot" placeholder="Tổng số chỗ"
                                       type="number" required value="{{$salon->max_slot}}">
                            </div>
