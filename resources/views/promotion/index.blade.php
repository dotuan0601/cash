...
@section('htmlheader_title')
    Danh sách thông tin khuyến mại
@endsection
        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Danh sách tin khuyến mại</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                        ...
                        @foreach ($posts as $post)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.promotion.edit', ['id' => $post->id]) }}"
                                    ...
                                    <form class="inline" method="POST"  onsubmit="return confirm('Bạn có chắc chắn muốn xóa nội dung này không?');"
                                          action="{{ route('admin.promotion.destroy', ['id' => $post->id]) }}">
                ...
                <div class="box-footer clearfix no-border">
                    <a href="{{ route('admin.promotion.create') }}" class="btn btn-flat btn-primary">Thêm bài viết mới</a>
                </div>
            </div>
            <!-- /.box -->
        </div>
