...
@section('meta-data')
    <meta property="og:url" content="{{route('news_detail',['slug'=>$post->slug])}}"/>
        ...
        <div class="row blog-content">
            <div class="col-md-8 blog-content-detail">
                ...
                <div class="ckps-author-like-share">
                    <div class="text-left mb-3">
                        ...
                        <div class="fb-share-button"
                             data-href="{{route('news_detail',['slug'=>$post->slug])}}"
                ...
                <h2 class="blog-title-1">Bình luận</h2>
                    ...
                    <div class="fb-comments" data-href="{{route('news_detail',['slug'=>$post->slug])}}" data-numposts="5"></div>
